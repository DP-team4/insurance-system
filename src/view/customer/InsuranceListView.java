	...
	public void show() {
		...
		if(input.equals("")) System.out.println("\n검색 조건을 입력해주세요");
            ...
            insurances.forEach(i -> {
            	...
            	System.out.println();
                System.out.println("보험상품명: " + i.getName());
                System.out.println("보험이름: " + i.getName());
                System.out.println("보험종류: " + i.getInsuranceCategory().name());
            	System.out.println("<약관 목록>");
                for(Clause clause : clauses) {
                	System.out.print("약관명: " + clause.getName() + ", ");
	                System.out.print("가입금액: " + clause.getInsuredAmount() + ", ");
	                System.out.println("보험료: " + clause.getPremium());
                }
            });
		}
	}
